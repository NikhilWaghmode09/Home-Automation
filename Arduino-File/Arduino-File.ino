 /***************************************************
  ...
  Project:- Home Automation and Monitoring (using Multiplexers)
  Edited by :- Dipan Roy
  
  Website:- https://mindwebs.org

  MinD Webs - Inspiring the Inspirers
...
#define WLAN_SSID       "SSID_NAME" //Wifi Name - Case and special character sensitive
...
#define AIO_USERNAME    "AIO_USERNAME"//"Enter username from Adafruit Account here"
#define AIO_KEY         "AIO_KEY"//"Enter Secret Key Provided in the dashboard"
